...
| Dataset generation is **near-perfectly uniform** (`g % k` modular arithmetic), unlike Zipfian real-world shop traffic.  | Acknowledged as a known simplification this redesign does *not* fully solve. See [[benchmark-pgbench-postgres#Limitations\|Limitations]] for details.  |
